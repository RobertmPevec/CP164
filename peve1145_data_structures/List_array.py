...
class List:
    ...
    def _linear_search(self, key):
        ...
        index = 0
        i = -1
        while i <= -1 and index < len(self._values):
    ...
    def insert(self, i, value):
        ...
        if i < -n:
            self._values = [new_value] + self._values
        elif i >= n:
            self._values = self._values + [new_value]
        else:
            if i < 0:
                i += n
            self._values = self._values[:i] + [new_value] + self._values[i:]
        return None
    ...
    def intersection(self, source1, source2):
        ...
        for n in source1:
            if n in source2_set and n not in repeat_values:
                repeat_values.append(n)
    ...
    def __eq__(self, target):
        ...
        if len(self._values) != len(target):
            ...
            index = 0
            while equals and index < len(target):
                if target[index] != self._values[index]:
                    equals = False
                index += 1
        return equals
    ...
    def split_alt(self):
        ...
        while self._values:
            if toggle:
                target1.append(self._values[0])
                self._values.pop(0)
            else:
                target2.append(self._values[0])
                self._values.pop(0)
            toggle = not toggle
        return target1, target2
